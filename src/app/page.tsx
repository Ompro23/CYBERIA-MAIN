  ...
  return (
    <>
      ...
      <div className="sm:flex h-full w-full md:hidden flex-col gap-10  py-32 flex justify-center  items-center lg:hidden 2xl:hidden xl:hidden">
        ...
        <h1 className="font-SpaceAge bg-cover  blur-in-text bg-center  text-center text-white  text-6xl font-semibold ">
          CYBERIA{" "}
          <p className="text-xs text-end text-white font-Poppins">
            Unleash the geek within
          </p>{" "}
        </h1>
        <p className="text-sm mx-8 text-gray-300 text-center font-Poppins">
        ...
        <div className="h-full overflow-hidden border-b-[1px] border-white/[0.2]  sm:pb-10 2xl:bg-gradient-to-b from-black to-[#141516] flex justify-center items-center flex-col mt-10">
          <h1 className="text-2xl font-Poppins border-b-2 border-white text-center">
            Our Location
          </h1>
          <AnimatedPinDemo />
        </div>
