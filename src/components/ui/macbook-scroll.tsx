    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <div
          ...
          <img src="/GamingLogo.jpg" className="h-[70px] grayscale object-contain transition-all sm:grayscale-0 duration-300 hover:grayscale-0 cursor-pointer hover:scale-125   w-[100px]" alt="" />
          </div>
        </div>
      </motion.div>
    </div>
