  ...
  return (
    ...
    >
      <Menu  setActive={setActive}>
        <a href="https://msubaroda.ac.in/" target="_blank" rel="noopener noreferrer"><Image className="sm:hidden" src="/Logo/msu.png" width={50} height={50} alt="" /></a>
       ...
       <MenuItem setActive={setActive} active={active} item="Events">
        ...
        <a href="https://www.msubaroda.ac.in/Accreditation" target="_blank" rel="noopener noreferrer"><Image className="sm:hidden" src="/Logo/75.png" width={50} height={50} alt="" /></a>
      </Menu>
    </div>
  );
}
